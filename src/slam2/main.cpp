...
int main(int argc, char** argv)
{
    ...
    QGuiApplication::setApplicationDisplayName( QObject::tr( "SLAM" ) );

    QCommandLineParser commandLineParser;
    commandLineParser.addHelpOption();
    commandLineParser.addPositionalArgument( QObject::tr( "[calibration]" ), QObject::tr( "Calibration file name." ) );
