...
public:
    ...
    bool saveYaml(std::string &fileName ) const;
...
public:
    ...
    void report( const MonocularCalibrationResults &calibration );
    const MonocularCalibrationResults &calibrationResults() const;

protected:
    MonocularCalibrationResults m_calibrationResults;
...
public:
    ...
    void report( const StereoCalibrationResults &calibration );
    const StereoCalibrationResults &calibrationResults() const;

protected:
    StereoCalibrationResults m_calibrationResults;
